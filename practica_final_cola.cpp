...
void cargar(struct Calificaciones **,struct Calificaciones **);
...
int main(void){
    int opcion = 0;
    char seguir = ' ';
    struct Calificaciones *front=NULL;
    struct Calificaciones *back=NULL;
    cargar(&front,&back);
    do{
        ...
        switch(opcion){
            ...
            case 3:
            {
                mostrar_reprobados(front);
                break;
            }
            case 4:
            {
                mostrar_aprobados(front);
                break;
            }
            case 5:
            {
                contar_alumnos(front);
                break;
            }
            case 6:
            {
                mostrar_ausentes(front);
                break;
            }
            case 7:
            {
...
void cargar (struct Calificaciones **front,struct Calificaciones **back){
...
void mostrar_curso(struct Calificaciones *front){
...
void mostrar_mejor(struct Calificaciones *front){
    struct Calificaciones *new_node = NULL;
    new_node = front;
    float nota_max = 0;
    int i=0;
...
void mostrar_reprobados(struct Calificaciones *front){
    struct Calificaciones *new_node=NULL;
    new_node = front;
...
void mostrar_aprobados(struct Calificaciones *front){
    struct Calificaciones *new_node = NULL;
    new_node = front;
...
void contar_alumnos(struct Calificaciones *front){
    struct Calificaciones *new_node=NULL;
    int cont=0;
    new_node = front;
    while(new_node!=NULL){
...
void mostrar_ausentes(struct Calificaciones *front){
    struct Calificaciones *new_node=NULL;
    new_node = front;
...
void archivo(struct Calificaciones *front){
    struct Calificaciones *new_node=NULL;
    new_node = front;
    FILE *fp;
