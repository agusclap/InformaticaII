...
void cargar(struct Calificaciones **head);
...
int main(void){
    ...
    do{
        ...
        switch(opcion){
            ...
            case 3:
            {
                mostrar_reprobados(head);
                break;
            }
            case 4:
            {
                mostrar_aprobados(head);
                break;
            }
            case 5:
            {
...
void mostrar_curso(struct Calificaciones *head){
    struct Calificaciones *temp = NULL;
    temp = head;
...
void mostrar_mejor(struct Calificaciones *head){
    struct Calificaciones *new_node = NULL;
    new_node = head;
    float nota_max = 0;
    int i=0;
...
void mostrar_reprobados(struct Calificaciones *head){
    struct Calificaciones *new_node=NULL;
    new_node = head;
...
void mostrar_aprobados(struct Calificaciones *head){
    struct Calificaciones *new_node = NULL;
    new_node = head;
...
void contar_alumnos(struct Calificaciones *head){
    struct Calificaciones *new_node=NULL;
    int cont=0;
    new_node = head;
    while(new_node!=NULL){
...
void mostrar_ausentes(struct Calificaciones *head){
    struct Calificaciones *new_node=NULL;
    new_node = head;
...
void archivo(struct Calificaciones *head){
    struct Calificaciones *new_node=NULL;
    new_node = head;
    FILE *fp;
